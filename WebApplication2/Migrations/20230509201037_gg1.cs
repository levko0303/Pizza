    ...
    public partial class gg1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PizzaToOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PizzaToOrder_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PizzaToOrder_Pizza_PizzaId",
                        column: x => x.PizzaId,
                        principalTable: "Pizza",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PizzaToOrder_OrderId",
                table: "PizzaToOrder",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PizzaToOrder_PizzaId",
                table: "PizzaToOrder",
                column: "PizzaId");
        }
