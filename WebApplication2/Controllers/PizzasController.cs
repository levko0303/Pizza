...
namespace WebApplication2.Controllers
{
    public class PizzasController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ImageTitle,PizzaName,BasePrice,TomatoSauce,Cheese,Peperoni,Mushroom,Tuna,Pineapple,Ham,Beef,FinalPrice")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
